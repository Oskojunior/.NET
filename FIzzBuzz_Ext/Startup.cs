...
namespace FizzBuzz_Ext
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, UserManager<FIzzBuzz_ExtUser> userManager, SignInManager<FIzzBuzz_ExtUser> signInManager)
        {
