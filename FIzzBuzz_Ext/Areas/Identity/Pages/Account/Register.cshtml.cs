...
namespace FIzzBuzz_Ext.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            UserManager<FIzzBuzz_ExtUser> userManager,
            SignInManager<FIzzBuzz_ExtUser> signInManager,
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new FIzzBuzz_ExtUser { UserName = Input.Email, Email = Input.Email };
